...
[Migration("20250305000000_AddImportBatchDiagnostics")]
partial class AddImportBatchDiagnostics
{
        ...
        modelBuilder.Entity("FinanceOverview.Api.Models.ImportBatch", b =>
            {
                ...
                b.Property<DateOnly?>("FirstBookingDate")
                    .HasColumnType("TEXT");

                b.Property<DateOnly?>("LastBookingDate")
                    .HasColumnType("TEXT");
